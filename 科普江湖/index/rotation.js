var box = document.getElementById("rotation");
var ul = document.getElementById("rotation-list");
var img = document.getElementById("pic");
var left_btn = document.getElementById("left");
var right_btn = document.getElementById("right");
var allLi = document.getElementsByClassName("rotation-li");
//第一步 ：第一个按钮设置为红色
var currentNUM = 1;
...
function changeIMG() {
    ...
    img.src = "../index/pic/" + currentNUM + ".jpg";
    //清空小圆点颜色，改变下一个颜色		
